...
controllers.controller('ContactController', ['$scope', '$http', '$window',
    function ($scope, $http, $window) {
        ...
        $scope.contact = function () {
            ...
            $scope.error = {};
            $http.post('/angularjs/api/contact', $scope.contactModel).success(
                    function (data) {
                        $scope.contactModel = {};
...
controllers.controller('DashboardController', ['$scope', '$http',
    function ($scope, $http) {
        $http.get('/angularjs/api/dashboard').success(function (data) {
...
controllers.controller('LoginController', ['$scope', '$http', '$window', '$location',
    function ($scope, $http, $window, $location) {
        $scope.login = function () {
            $scope.submitted = true;
            $scope.error = {};
            $http.post('/angularjs/api/login', $scope.userModel).success(
                    function (data) {
